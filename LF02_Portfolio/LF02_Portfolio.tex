...
%exlclusively used for subsection text
...
%defines an environment that applies a custom indent to text inside
%exclusively used for reflexion subsection text
...
\newpage
\input{chapters/2_9_angebotsvergleiche.tex}

\newpage
\input{chapters/2_10_lieferung-install-uebergabe.tex}

\newpage
\input{chapters/2_11_kontrolle-reflexion.tex}
