...
\subsection{Prozessoren genauer beschreiben}
    ...
    \begin{tcolorbox}[width=15cm, center, title=CPU Begriffe, coltitle=white, colframe=orange, colback=white!60!orange]
        \begin{itemize}[itemsep=0.1em, parsep=0.3em]
            ...
            \item Erhöhung der Taktfrequenz\@: \\ Maximale Taktfrequenz kann durch Übertaktung erhöht werden, ist mit Erhöhung des Energieverbrauchs, Wärmeentwicklung und Kühlerlautstärke verbunden
...
\subsection{IT-Zubehör für die Barrierefreiheit und im Aftersales unterscheiden}
    %TODO more accessibility infos possible
    \begin{tcolorbox}[width=15cm, center, title=Barrierefreiheit in der IT, coltitle=white, colframe=orange, colback=white!60!orange]
        Verfolgt das Ziel, digitale Anwendungen und Infoangebote für jeden nutzbar zu machen, z.B. durch Zusatzfunktionen in Andenwunden und OS oder durch gänzlich barrierefreie Betriebssysteme. 
        Ebenfalls kommen individuelle Hilfsmittel zum Einsatz, z.B. andere Art der Mauszeigerbedienung.
    \end{tcolorbox}

    \begin{subindent}
        Anforderungen und Zubehör unter Aspekten der Gesundheit und Barrierefreiheit
        \begin{itemize}[leftmargin=2.5cm, topsep=0.2em, itemsep=0.1em, parsep=0.1em]
            \item Ergonomische Geräte\@: Fußstützen/-auflagen, Handballenauflagen, Tastaturhalter, etc.
            \item Blaulichtfilter
            \item Sehhilfen/Blindenhilfen
            \item Software-/Betriebssystemzusatzfunktionen\@: Vorlesefunktion, Lupenfunktion
            \item Anforderungskategorien der Barrierefreiheit: \\ 
                  1. Wahrnehmbarkeit (Benutzerschnittstelle muss wahrnehmbar präsentiert werden) \\ 
                  2. Bedienbarkeit (Benutzerschnittstelle muss bedienbar sein) \\
                  3. Verständlichkeit (Benutzerschnittstelle muss verständlich sein) \\
                  4. Robustheit (Inhalte müssen zuverlässig nutzbar sein)
            \item Einhaltung der gesetzlichen Anforderungen
        \end{itemize}
    \end{subindent}
...
\subsection{Marktgängige IT-Systeme und Lösungen anbieten}
    \begin{subindent}
        ...
        \begin{itemize}[leftmargin=2.5cm, topsep=0.2em, itemsep=0.1em, parsep=0.1em]
            \item IT-Sourcing\@: \\
                  externe Beschaffung von IT-Dienstleistungen und -Services
            \item IT-Outsourcing\@: \\
                  unbefristete Auslagerung von umfangreichen IT-Aufgaben oder -Abteilungen an externes Unternehmen
            \item Managed-Services\@: \\
                  IT-Dienstleistungen, die Service-Provider für Unternehmen befristet per SLA (Service-Level-Agreement) erbringt
            \item Desktop-Services\@: \\
                  Bereitstellung, Wartung und Erneuerung der Hard- und Software
            \item User-Helpdesk\@: \\
                  Betreuung der Andwender im Unternehmen
            \item Application Service Providing\@: kurz ASP \\
                  Bereitstellung von Anwendungen mit entsprechenden Dienstleistungen (meist per Datenteilung vernetzt)
            \item On-Site-Management\@: \\
                  Übernahme von Funktionen eines Teils des Kundenbetriebes durch externen Dienstleister
            \item Service Level Agreements\@: kurz SLA \\
                  Umfang, Art und Qualität der zu erbringenden Leistungen werden in einem Rahmenvertrag, bzw. einem SLA, festgehalten
        \end{itemize}
    \end{subindent}    
