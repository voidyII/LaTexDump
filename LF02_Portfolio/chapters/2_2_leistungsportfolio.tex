...
\addcontentsline{toc}{subsection}{Reflexion Kapitel 2.2}
    \begin{refindent}
        IT kommt fast in allen wirtschaftlichen und privaten Bereichen. Die Arbeitsplätze fallen dabei ganz unterschiedlich aus. Auch die Hardware, die benutzt wird, kommt in verschiedenen Spezifikationen.
        Wichtig ist bei der Zusammensetzung, dass die Komponenten aufeinander abgestimmt sind. \\
        Der Begriff Leistungsportfolio ist selbsterklärend.
    \end{refindent}